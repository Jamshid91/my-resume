...
document.querySelector('button.place_bet_button').onclick = addMyCardInfo;
...
function addMyCardInfo () {
  ...
  let cards = document.querySelectorAll('.auction_participants_list');
  let userLevelNums = document.querySelectorAll('.user_level_num');
  ...
  <div class="user_info">
    ...
    <div class="user_level d-flex">
      <span class="user_level_num pr-2">${cards.length + 1}</span>
      <span>место</span>
    </div> 
  </div>
  <div>
